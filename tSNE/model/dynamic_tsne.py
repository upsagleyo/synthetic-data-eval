...
from tSNE.model.core import floath
from tSNE.model.core import cost_var
from tSNE.model.core import find_sigma
...
def dynamic_tsne(Xs, perplexity=30, Ys=None, output_dims=2, n_epochs=80,
